                        ...
                        <div class="card rounded-3 p-3 mt-2 text-center" style="border:none; overflow:hidden;">
                            <div class="row align-items-center options" >
                                <div class="links col-md-6 mt-2">
                                    <a class="main-link" href="cancelledOrders.php">Recent Cancelled Orders</a>
                                </div>
                                <div class="links col-md-6 mt-2">
                                    <a class="main-link active" href="#">Previous Cancelled Orders</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <table class="table text-center">
                        ...
                        <tbody>
                                    ...
                                    <tr style="text-align: center; vertical-align: middle;">
                                        ...
                                        <td>
                                            <a href="cancelledDetails.php?id=<?= $order['order_transac_id']; ?>" style="margin-top: 10px;" class="btn BlueBtn">View Details</a>
                                        </td>
                                        <td>
