            ...
            <div class="container px-4">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-8">
                        <h1 class="title text-center mb-4" style="font-size:32px">Verify Email</h1>
                        <form action="functions/authcode.php" method="POST">
                            <div class="input-box mb-3">
                                <input type="text" class="form-control" placeholder="Enter verification code" name="forgotVerifyCode" required>
                            </div>
                            <button type="submit" name="forgotVerifyBtn" class="btn btn-primary w-100">Submit</button> 
