...
<section class="homepage" id="Home" style="background-image: url('assets/images/Aquaflowbg.png'); background-size: cover;">
  <div class="quote d-none d-md-block" style="position: absolute; top: 120px; right: 100px;">
    <div class="align-items-center justify-content-between" style="margin-top: 10px;">
...
<!--------------- ABOUT US --------------->
<section class="pt-lg-3" id="AboutUs" style="background-color: white; padding-top: 20px" >
