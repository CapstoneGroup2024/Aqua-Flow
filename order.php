...
<section class="p-5 p-md-5 mt-2 text-sm-start" id="Order">
    ...
    <div class="row">
            ...
            <div class="row justify-content-center">
                <?php foreach($products as $product): ?>
                    ...
                    <div class="col-md-3 col-9 product-data" style="margin-bottom: 20px; margin-right: -20px;">
                        ...
                        <label style="border: 4px solid transparent; border-radius: 14px; cursor: pointer; transition: border-color 0.3s ease; display: block;" onclick="toggleRadio(this, 'product');">
                            <input type="radio" name="selectedProduct" value="<?= $product['id']; ?>" class="card-input-element" style="display:none;">
                            <div class="card changeBorder" style="border: 2px solid transparent; border-radius:11px">
        ...
        <div class="category" id="categ" style="margin-top: -70px;">
            ...
            ?>
            <div class="row justify-content-center">
                <label style="cursor: pointer; transition: border-color 0.3s ease; display: block; margin-bottom: 10px;" onclick="toggleRadio(this, 'category');">
                    <div class="card mb-0 changeBorder" style="border: 2px solid transparent; max-width: 80rem; border-radius: 10px; background-color: <?= $current_color; ?>">
                        <div class="row g-0">
                            <div class="col-md-2">
                                <!-- CATEGORY IMAGE -->
            ...
            <div class="card" id="quantitybox">
                <div class="addqty">
                    <div class="row align-items-center">
                        <div class="col-lg-9 col-5" style="margin-left: 40px">
                            <h2 style="font-weight: bold; font-family: 'Poppins', sans-serif;">Quantity</h2>
                        </div>
                        <div class="col-md-3 col-4" style="width: 180px">
...
<script>
        function toggleRadio(label, type) {
            var radios = document.querySelectorAll('input[type="radio"]');
            var cards = document.querySelectorAll('.changeBorder');

            // Reset border color only for the specific type
            if (type === 'product') {
                var productLabels = document.querySelectorAll('input[name="selectedProduct"]');
                productLabels.forEach(function(productLabel) {
                    productLabel.closest('label').querySelector('.changeBorder').style.borderColor = 'transparent';
                });
            } else if (type === 'category') {
                var categoryLabels = document.querySelectorAll('input[name="selectedCategory"]');
                categoryLabels.forEach(function(categoryLabel) {
                    categoryLabel.closest('label').querySelector('.changeBorder').style.borderColor = 'transparent';
                });
            }
